...
def test_rsi(input_fluctuations):
    rsi_line = rsi(input_fluctuations, window_size=3)
...
def test_stochastic_rsi(input_fluctuations):
    stochastic_rsi_line, rsi_k, rsi_d = stochastic_rsi(
        input_fluctuations, window_size=2, smooth_k=1, smooth_d=1
    )
    ...
    stochastic_rsi_line, rsi_k, rsi_d = stochastic_rsi(
        input_fluctuations, window_size=2, smooth_k=2, smooth_d=3
    )
