...
def test_ichimoku(input_fluctuations):
    ...
    span_a_left, span_b_left, conversion_line_left, base_line_left = ichimoku(
        fluctuations=input_fluctuations, window_a=1, window_b=1, window_c=1
    )

    span_a_right, span_b_right, conversion_line_right, base_line_right = ichimoku(
        fluctuations=input_fluctuations, window_a=2, window_b=3, window_c=2
    )
